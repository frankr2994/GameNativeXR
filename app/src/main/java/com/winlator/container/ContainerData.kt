...
data class ContainerData(
    ...
    val xrButtonA: Int = Container.DEFAULT_XR_BUTTON_A,
    val xrButtonB: Int = Container.DEFAULT_XR_BUTTON_B,
    val xrButtonX: Int = Container.DEFAULT_XR_BUTTON_X,
    val xrButtonY: Int = Container.DEFAULT_XR_BUTTON_Y,
    val xrButtonGrip: Int = Container.DEFAULT_XR_BUTTON_GRIP,
    val xrButtonTrigger: Int = Container.DEFAULT_XR_BUTTON_TRIGGER,
    val xrThumbstickUp: Int = Container.DEFAULT_XR_THUMBSTICK_UP,
    val xrThumbstickDown: Int = Container.DEFAULT_XR_THUMBSTICK_DOWN,
    val xrThumbstickLeft: Int = Container.DEFAULT_XR_THUMBSTICK_LEFT,
    val xrThumbstickRight: Int = Container.DEFAULT_XR_THUMBSTICK_RIGHT,
    val xrCPULevel: Int = 75,
    val xrGPULevel: Int = 75,
        ...
        val Saver = mapSaver(
            save = { state ->
                mapOf(
                    ...
                    "xrButtonA" to state.xrButtonA,
                    "xrButtonB" to state.xrButtonB,
                    "xrButtonX" to state.xrButtonX,
                    "xrButtonY" to state.xrButtonY,
                    "xrButtonGrip" to state.xrButtonGrip,
                    "xrButtonTrigger" to state.xrButtonTrigger,
                    "xrThumbstickDown" to state.xrThumbstickDown,
                    "xrThumbstickUp" to state.xrThumbstickUp,
                    "xrThumbstickLeft" to state.xrThumbstickLeft,
                    "xrThumbstickRight" to state.xrThumbstickRight,
                    "xrCPULevel" to state.xrCPULevel,
                    "xrGPULevel" to state.xrGPULevel,
            ...
            restore = { savedMap ->
                ContainerData(
                    ...
                    xrButtonA = (savedMap["xrButtonA"] as? Int) ?: Container.DEFAULT_XR_BUTTON_A,
                    xrButtonB = (savedMap["xrButtonB"] as? Int) ?: Container.DEFAULT_XR_BUTTON_B,
                    xrButtonX = (savedMap["xrButtonX"] as? Int) ?: Container.DEFAULT_XR_BUTTON_X,
                    xrButtonY = (savedMap["xrButtonY"] as? Int) ?: Container.DEFAULT_XR_BUTTON_Y,
                    xrButtonGrip = (savedMap["xrButtonGrip"] as? Int) ?: Container.DEFAULT_XR_BUTTON_GRIP,
                    xrButtonTrigger = (savedMap["xrButtonTrigger"] as? Int) ?: Container.DEFAULT_XR_BUTTON_TRIGGER,
                    xrThumbstickUp = (savedMap["xrThumbstickUp"] as? Int) ?: Container.DEFAULT_XR_THUMBSTICK_UP,
                    xrThumbstickDown = (savedMap["xrThumbstickDown"] as? Int) ?: Container.DEFAULT_XR_THUMBSTICK_DOWN,
                    xrThumbstickLeft = (savedMap["xrThumbstickLeft"] as? Int) ?: Container.DEFAULT_XR_THUMBSTICK_LEFT,
                    xrThumbstickRight = (savedMap["xrThumbstickRight"] as? Int) ?: Container.DEFAULT_XR_THUMBSTICK_RIGHT,
                    xrCPULevel = (savedMap["xrCPULevel"] as? Int) ?: 75,
                    xrGPULevel = (savedMap["xrGPULevel"] as? Int) ?: 75,
