...
class ContainerConfigState(
    ...
    val xrButtonA: MutableIntState,
    val xrButtonB: MutableIntState,
    val xrButtonX: MutableIntState,
    val xrButtonY: MutableIntState,
    val xrButtonGrip: MutableIntState,
    val xrButtonTrigger: MutableIntState,
    val xrThumbstickUp: MutableIntState,
    val xrThumbstickDown: MutableIntState,
    val xrThumbstickLeft: MutableIntState,
    val xrThumbstickRight: MutableIntState,
    val xrCPULevel: MutableIntState,
    val xrGPULevel: MutableIntState,
    val xrRefreshRate: MutableIntState,
